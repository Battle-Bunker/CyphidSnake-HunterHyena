...
func main() {
	...
	portfolio := agent.NewPortfolio(
		...
		agent.NewHeuristic(100.0, "team-health", HeuristicHealth), 
		agent.NewHeuristic(100.0, "food-distance", HeuristicFood),
		//agent.NewHeuristic(100.0, "flood-fill", HeuristicFreeSpace),
